...
- **Go**: Backend development with RESTful APIs, used in my WASA project.
- **Vue.js**: Frontend development for modern web applications.
...
### Projects
- [**WASAPhoto**](https://github.com/FerrettiGiovanni/wasa-project): A full-stack social media application developed for the Web and Software Architecture course. Built with Go (backend) and Vue.js (frontend), featuring photo sharing, messaging, reactions, and group conversations. Containerized with Docker.
